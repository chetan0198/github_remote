...
# data={'timestamp_key': '2024-01-15 17:33:19.805397', 'symbol': 'AAPL', 'price': 371.85, 'volume': 701860}
# print(type(data))
spark=SparkSession.builder.appName('test').getOrCreate()
# print(spark)

# # df=spark.createDataFrame(data=[(1,'xhetan'),(1,'xhetan'),(1,'xhetan')],schema='id int,name string')
# df=spark.createDataFrame(data=data,schema='timestamp_key string, symbol string, price int, volume int')
# print('-------------',df.show())
